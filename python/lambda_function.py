import json
from python.DB_insertion import insert_demo_data_into_table
from python.DB_creation import create_raw_tables
from python.DB_insertion import insert_vehicles_into_table
from python.DB_insertion import insert_weather_into_table
